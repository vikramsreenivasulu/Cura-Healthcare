...
public class Report{
	...
	public static void screenshotBase64() {
		String base64Screenshot = ((TakesScreenshot) BaseClass_CuraHealthcare.driver).getScreenshotAs(OutputType.BASE64);
	...
	public static String caputreScreenshot(String fileName) {
		TakesScreenshot ts = (TakesScreenshot) BaseClass_CuraHealthcare.driver;
